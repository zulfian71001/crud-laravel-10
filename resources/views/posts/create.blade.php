    ...
    <div class="w-auto h-auto bg-white rounded-md m-6 flex flex-col p-4">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="w-full rounded-md @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" placeholder="Masukkan Judul Post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="w-full rounded-md @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukkan Konten Post">{{ old('content') }}</textarea>
